...
function askBot() {
    ...
    $("send").click(function () {
        ...
        var user_bot_input_text = $("predict").val()

        if (user_bot_input_text != "predict") {
           
            // adicione um novo elemento div na janela de conversa
            $("bot").append('<div class="user__messages">' + user_bot_input_text + ' </div>')
            ...
            $.ajax({
                ...
                url: ("./static/assets/datafiles/data_entry.csv",'a'),
